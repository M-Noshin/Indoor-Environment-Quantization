...
/*
 * This header file was automatically @generated for the indoor_env_1d_91_q8824 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 217,580 ops (215,560 macc; 2,020 comp; 0 add; 0 mul; 0 bitwise)
    Layer 0: 6,370 ops (5,460 macc; 910 comp; 0 add; 0 mul; 0 bitwise)
    Layer 1: 28,210 ops (27,300 macc; 910 comp; 0 add; 0 mul; 0 bitwise)
    Layer 2: 182,200 ops (182,000 macc; 200 comp; 0 add; 0 mul; 0 bitwise)
    Layer 3: 800 ops (800 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 46,260 bytes out of 2,396,160 bytes total (1.9%)

...
#SBATCH --job-name=indoor-hawq-p05
#
# Alphas: 21 11 5  (3 lengths). ACE after all parts complete.
#   sbatch .../slurm_hawq_qat_alpha_part05.sh
...
HAWQ_CSV="${HAWQ_DIR}/hawq_frontier_candidates_part05.csv"
OUT_TAG="hawq_qat_frontier_p05"

...
#SBATCH --job-name=indoor-hawq-p03
#
# Alphas: 61 51  (2 lengths). ACE after all parts complete.
#   sbatch .../slurm_hawq_qat_alpha_part03.sh
...
HAWQ_CSV="${HAWQ_DIR}/hawq_frontier_candidates_part03.csv"
OUT_TAG="hawq_qat_frontier_p03"

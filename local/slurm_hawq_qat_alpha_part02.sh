...
#SBATCH --job-name=indoor-hawq-p02
#
# Alphas: 81 71  (2 lengths). ACE after all parts complete.
#   sbatch .../slurm_hawq_qat_alpha_part02.sh
...
HAWQ_CSV="${HAWQ_DIR}/hawq_frontier_candidates_part02.csv"
OUT_TAG="hawq_qat_frontier_p02"

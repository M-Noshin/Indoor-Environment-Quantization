...
#SBATCH --job-name=indoor-hawq-p04
#
# Alphas: 41 31  (2 lengths). ACE after all parts complete.
#   sbatch .../slurm_hawq_qat_alpha_part04.sh
...
HAWQ_CSV="${HAWQ_DIR}/hawq_frontier_candidates_part04.csv"
OUT_TAG="hawq_qat_frontier_p04"
